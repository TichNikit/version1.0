...
async def delete_user(db: Annotated[Session, Depends(get_db)], user_id: int):
    ...
    db.execute(delete(UserGameFeedback).where(UserGameFeedback.game_id == user_id)).all()
    db.execute(delete(UserGameRating).where(UserGameRating.game_id == user_id)).all()
    db.commit()
